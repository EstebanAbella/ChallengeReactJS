...
export type PosibleActions = { type: 'CLIENTS_FETCHING' } | { type: 'CLIENTS_FETCH'; payload: clientListType[] } | { type: 'CLIENTS_FETCH_ERROR' }

const reducer = (state = globalState, action: PosibleActions): ClientsReducerPropsType => {
	switch (action.type) {
